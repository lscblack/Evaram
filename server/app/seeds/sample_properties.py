...
PROPERTIES: list[dict] = [
    # ------------------------------------------------ residential land
    {
        ...
        "intent": "sale", "price": 42_000_000, "currency": "RWF", "is_featured": True,
    ...
    # ------------------------------------------------ residential building
    {
        ...
        "intent": "sale", "price": 128_000_000, "currency": "RWF", "is_featured": True,
    ...
    # ------------------------------------------------ agricultural — seasonal crops
    {
        ...
        "intent": "sale", "price": 74_000_000, "currency": "RWF", "is_featured": True,
    ...
    # ------------------------------------------------ agricultural — plantation
    {
        ...
        "intent": "sale", "price": 152_000_000, "currency": "RWF", "is_featured": True,
    ...
    # ------------------------------------------------ commercial — apartment block
    {
        ...
        "intent": "sale", "price": 465_000_000, "currency": "RWF", "is_featured": True,
    ...
    # ------------------------------------------------ public
    {
        ...
        "intent": "sale", "price": 88_000_000, "currency": "RWF",
    ...
    # ------------------------------------------------ agricultural — aquaculture
    {
        ...
        "intent": "sale", "price": 118_000_000, "currency": "RWF", "is_featured": True,
